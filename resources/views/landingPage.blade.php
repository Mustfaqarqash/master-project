                    ...
                    <div class="col-lg-5 col-md-5 u-s-m-b-30">
                        ...
                        <a class="collection" href="shop-side-version-2.html">
                            <div class="aspect aspect--bg-grey aspect--square">
                                ...
                                <img class="aspect__img collection__img" src="{{asset('assets/asset/images/collection/coll-1.jpg')}}" alt=""></div>
                        </a></div>
                    <div class="col-lg-7 col-md-7 u-s-m-b-30">
                        ...
                        <a class="collection" href="shop-side-version-2.html">
                            <div class="aspect aspect--bg-grey aspect--1286-890">
                                ...
                                <img class="aspect__img collection__img" src="{{asset('assets/asset/images/collection/coll-2.jpg')}}" alt=""></div>
                        </a></div>
                    <div class="col-lg-7 col-md-7 u-s-m-b-30">
                    ...
                    <div class="col-lg-5 col-md-5 u-s-m-b-30">
                        ...
                        <a class="collection" href="shop-side-version-2.html">
                            <div class="aspect aspect--bg-grey aspect--square">
                                ...
                                <img class="aspect__img collection__img" src="{{asset('assets/asset/images/collection/coll-4.jpg')}}" alt=""></div>
                        </a></div>
                </div>
            </div>
        </div>
