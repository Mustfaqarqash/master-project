    ...
    <div class="position-relative">
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner py-6 mx-4">
                ...
                <div class="card p-7">
                    ...
                    <div class="app-brand justify-content-center mt-5">
                        ...
                        <span class="app-brand-logo demo">
                            ...
                            <span class="app-brand-text demo text-heading fw-semibold">Your Brand</span>
                        </a>
                    </div>
                    <!-- /Logo -->

                    <div class="card-body mt-1">
                        <h4 class="mb-1">Welcome to Your App! 👋🏻</h4>
                ...
                <img src="../assets/img/illustrations/auth-basic-mask-light.png" class="authentication-image d-none d-lg-block" height="172" alt="triangle-bg" data-app-light-img="illustrations/auth-basic-mask-light.png" data-app-dark-img="illustrations/auth-basic-mask-dark.png" />
